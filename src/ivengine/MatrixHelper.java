...
public class MatrixHelper 
{
	...
	/**
	 * For a base <u>, <v> and <w> gets the matrix used from this base to the global one
	 */
	public static Matrix4f createBaseChangeMatrixToGlobal(Vector3f u,Vector3f v,Vector3f w)
	{
		return createBaseChangeMatrixToGlobal(u,v,w,new Matrix4f());
	}
	public static Matrix4f createBaseChangeMatrixToGlobal(Vector3f u,Vector3f v,Vector3f w,Matrix4f toRet)
	{		
		//Im filling it transposed
		toRet.m00=u.x;	toRet.m01=u.y;	toRet.m02=u.z;	toRet.m03=0;
		toRet.m10=v.x;	toRet.m11=v.y;	toRet.m12=v.z;	toRet.m13=0;
		toRet.m20=w.x;	toRet.m21=w.y;	toRet.m22=w.z;	toRet.m23=0;
		toRet.m30=0;	toRet.m31=0;	toRet.m32=0;	toRet.m33=1;
